...
async def talk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await send_text_buttons(update, context, text, {
        ...
        'talk_queen': 'Королева Елизавета - Королева Соединённого Королевства 👑',
        'talk_tolkien': 'Джон Толкиен - Автор книги "Властелин Колец" 📖',
        'talk_monroe': 'Мэрэлин Монро - Киноактриса, певица, модель и секс-символ 1950-х годов 👸',
        'talk_bulgakov': 'Михаил Булгаков -  Русский писатель, врач, драматург 📚',
        'talk_gogol': 'Николай Гоголь - Прозаик, драматург, критик, публицист, признанный одним из классиков русской литературы 🕯',
        'talk_kleopatra': 'Клеопатра - Последняя царица эллинистического Египта 🛕',
        'talk_mask': 'Илон Маск - Основатель, генеральный директор и главный инженер компании SpaceX 🦾',
        'talk_rasputin': 'Григорий Распутин - «Царского друг», «старец» 🔮'
    })
